...
$(document).ready(function () {
	...
	$('#qsSlider').qsSlider({
		...
		MaxRAM	: '124',		// Maximum RAM //It should be + 2 like if you want maximum RAM 16 GB then make it 18 etc..		
		...
		BuyNowLink : 'https://yourwhmcslink.com/cart.php?a=add&currency=1&pid=127',
